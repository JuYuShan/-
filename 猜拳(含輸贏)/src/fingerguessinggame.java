...
public class fingerguessinggame {
	...
	static Label NumberofBoard = new Label("局數 ：",Label.CENTER);
	static Label drawn = new Label("和局次數 ：",Label.CENTER);
	static Label Lose = new Label("輸的次數 ：",Label.CENTER);
	static Label Win = new Label("贏的次數 ：",Label.CENTER);
